...
class ForexData:
            ...
            for symbol in self._symbols:
                ...
                for week in (1, 2, 3, 4, 5):
                    try:
                        ...
                        continue
                    temp_path = self._extract_zip(zip)
    ...
    def _transform(self, temp_path, symbol_dir):
        ...
        """
        for dt, daily_lines in self._read_daily_lines(temp_path):
            final_path = os.path.join(symbol_dir, "{}.csv".format(dt.strftime("%Y-%m-%d")))
    ...
    def _read_daily_lines(self, temp_path):
        """
